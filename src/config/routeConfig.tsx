...
export const OurApproachPageSection = lazy(() =>
  import('@/pages/approach/index').then(module => ({
    default: module.default
  }))
);

export const TreatmentPageSection = lazy(() =>
  import('@/pages/treatment/index').then(module => ({
    default: module.default
  }))
);
...
export const RegistrationForm = lazy(() =>
  import('@/components/sections/quiz/RegistrationForm').then(module => ({
