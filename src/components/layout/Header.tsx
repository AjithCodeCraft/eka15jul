...
// Enhanced navigation items with holistic wellness focus
          ...
          <div className="hidden lg:flex items-center space-x-4 ml-auto">
            ...
            <Link to="/quiz">
              <Button
                ...
                aria-label="Take the dosha quiz to discover your constitution"
                size="sm"
                className="bg-gradient-to-r from-pink-600 to-pink-700 hover:from-pink-700 hover:to-pink-800 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 whitespace-nowrap font-medium transform hover:scale-105 active:scale-95 focus:ring-2 focus:ring-pink-500 focus:ring-opacity-50"
                style={{ padding: '12px 20px', letterSpacing: '0.5px' }}
              >
                <Sparkles className="w-4 h-4 mr-2" />
                Take Quiz
              ...
              <div className="flex flex-col h-full">
                ...
                <div className="p-4 border-t border-teal-100 sticky bottom-0 bg-white space-y-2">
                  <Link to="/quiz" onClick={() => setIsMobileMenuOpen(false)}>
                    <Button 
                      className="w-full bg-gradient-to-r from-pink-600 to-pink-700 hover:from-pink-700 hover:to-pink-800 text-white rounded-full transform transition-all duration-300 active:scale-95"
                      aria-label="Take the dosha quiz to discover your constitution"
                      onClick={(e) => {
